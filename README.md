...
Module to populate a gitops repository with the resources to write the database credentials in a secret in the cluster
...
module "database_secret" {
   source = "github.com/cloud-native-toolkit/terraform-gitops-database-secret.git"
